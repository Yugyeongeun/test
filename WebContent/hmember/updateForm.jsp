...
function inCheck(f){ //매개변수는 다 선언을 안한다.
...
<div class="container">
	...
	<form class="form-horizontal" 
		...
		<div class="form-group">
			...
			<div class="col-sm-4">
				<input type="text" class="form-control" id="tel" value="<%=dto.getTel() %>"
				name="tel">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-1">
				<input type="text" class="form-control" id="sample6_postcode" value="<%=dto.getZipcode() %>" name="zipcode">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control" id="sample6_address" value="<%=dto.getAddress1() %>" name="address1">
				<input type="text" class="form-control" id="sample6_detailAddress" value="<%=dto.getAddress2() %>" name="address2">
			</div>
		</div>

...
public class AdminLoginCheckFilter implements Filter {
    ...
    public void init(FilterConfig arg0) throws ServletException {    //아무것도 안해도 오버라이딩 해줘야함
    }
    ...
    throws IOException, ServletException {
        ...
        if (login) {
            ...
            RequestDispatcher dispatcher = 
                request.getRequestDispatcher("/hmember/loginForm.jsp");
            dispatcher.forward(request, response);
        }
    }
 
    public void destroy() {   //아무것도 안해도 오버라이딩 해줘야함
    }
}
